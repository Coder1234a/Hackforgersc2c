...
const ALL_RULES = ["REVERSE_GRAVITY","INVERTED_CONTROLS","NO_JUMP","MOMENTUM",
                   "BULLETS_PUSH","SHIFTING_PLATFORMS","MOVEMENT_COSTS_TIME"];

const EVENT_ELIMINATES = {
    MOVED_SAME_DIRECTION:     ["INVERTED_CONTROLS"],
    MOVED_OPPOSITE_DIRECTION: ["REVERSE_GRAVITY","NO_JUMP","MOMENTUM","BULLETS_PUSH","SHIFTING_PLATFORMS","MOVEMENT_COSTS_TIME"],
    STOPPED_PROMPTLY:         ["MOMENTUM"],
    KEPT_SLIDING:             ["REVERSE_GRAVITY","INVERTED_CONTROLS","NO_JUMP","BULLETS_PUSH","SHIFTING_PLATFORMS","MOVEMENT_COSTS_TIME"],
    JUMP_ROSE:                ["NO_JUMP","REVERSE_GRAVITY"],
    JUMP_NOTHING:             ["REVERSE_GRAVITY","INVERTED_CONTROLS","MOMENTUM","BULLETS_PUSH","SHIFTING_PLATFORMS","MOVEMENT_COSTS_TIME"],
    JUMP_FELL:                ["INVERTED_CONTROLS","NO_JUMP","MOMENTUM","BULLETS_PUSH","SHIFTING_PLATFORMS","MOVEMENT_COSTS_TIME"],
    LANDED_STABLE:            ["SHIFTING_PLATFORMS"],
    LANDED_REARRANGED:        ["REVERSE_GRAVITY","INVERTED_CONTROLS","NO_JUMP","MOMENTUM","BULLETS_PUSH","MOVEMENT_COSTS_TIME"],
    BULLET_HURT:              ["BULLETS_PUSH"],
    BULLET_SHOVED:            ["REVERSE_GRAVITY","INVERTED_CONTROLS","NO_JUMP","MOMENTUM","SHIFTING_PLATFORMS","MOVEMENT_COSTS_TIME"],
    TIMER_WALL_CLOCK:         ["MOVEMENT_COSTS_TIME"],
    TIMER_PER_STEP:           ["REVERSE_GRAVITY","INVERTED_CONTROLS","NO_JUMP","MOMENTUM","BULLETS_PUSH","SHIFTING_PLATFORMS"]
};
